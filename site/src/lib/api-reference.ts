  ...
  xlsx: [
    ...
    },
    {
      ...
      methods: [
        ...
        { sig: 'renderViewport(canvas, sheetIndex, viewport, opts?: { width?, height?, dpr?, cellScale?, math? }): Promise<void>', desc: 'Render a row/col window of a sheet into the given canvas. Pass `math` (from @silurus/ooxml/math) to render OMML equations embedded in shapes; omit it and they are skipped.' },
        { sig: 'destroy(): void', desc: 'Release the worker.' },
      ],
    },
  ],
