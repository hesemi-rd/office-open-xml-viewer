 ...
 *
 * The fixture lives at public/validation-fixture.xlsx (gitignored, generated by
 * /tmp/gen_validation_fixture.py). It is NOT a VRT reference — this spec asserts
...
test.describe('xlsx list data-validation dropdown panel', () => {
  ...
  test('arrow click opens a panel listing allowed values; outside click closes', async ({ page }) => {
